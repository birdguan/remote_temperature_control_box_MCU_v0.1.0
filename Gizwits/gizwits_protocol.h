...
#define DeviceOnOff_BYTEOFFSET                    0
#define DeviceOnOff_BITOFFSET                     0
#define DeviceOnOff_LEN                           1

#define TempSet_RATIO                         1
#define TempSet_ADDITION                      0
#define TempSet_MIN                           0
#define TempSet_MAX                           255
#define TempNow_RATIO                         1
#define TempNow_ADDITION                      0
#define TempNow_MIN                           0
#define TempNow_MAX                           255
...
* @{
*/
#define PRODUCT_KEY "eb6b2a5b799b4180bab61e847bfe035f"
/**@} */
/**@name Product Secret (产品密钥)
* @{
*/
#define PRODUCT_SECRET "2ae3fbf3dae640b98b9fc31a54e54ce7"
/**@} */
...
* @{
*/
#define RGBLEDSW_BYTEOFFSET                    0
#define RGBLEDSW_BITOFFSET                     0
#define RGBLEDSW_LEN                           1

#define AUTOSET_BYTEOFFSET                    0
#define AUTOSET_BITOFFSET                     1
#define AUTOSET_LEN                           1


#define RLED_RATIO                         1
#define RLED_ADDITION                      0
#define RLED_MIN                           0
#define RLED_MAX                           255

#define GLED_RATIO                         1
#define GLED_ADDITION                      0
#define GLED_MIN                           0
#define GLED_MAX                           255

#define BLED_RATIO                         1
#define BLED_ADDITION                      0
#define BLED_MIN                           0
#define BLED_MAX                           255

#define LIGHTVAL_RATIO                         1
#define LIGHTVAL_ADDITION                      0
#define LIGHTVAL_MIN                           0
#define LIGHTVAL_MAX                           100
...
/** 用户区设备状态结构体*/
typedef_t struct {
  bool valueDeviceOnOff;
  uint32_t valueTempSet;
  uint32_t valueTempNow;
} dataPoint_t;

/** 对应协议“4.10 WiFi模组控制设备”中的标志位"attr_flags" */ 
typedef_t struct {
	uint8_t flagDeviceOnOff:1;
  uint8_t flagTempSet:1;
} attrFlags_t;

/** 对应协议“4.10 WiFi模组控制设备”中的数据值"attr_vals" */
typedef_t struct {
  uint8_t wBitBuf[COUNT_W_BIT];
  uint8_t valueTempSet;
} attrVals_t;
...
uint32_t gizGetTimerCount(void);											//添加进入头文件，方便其他.c调用，以免出现警告
int8_t gizwitsEventProcess(eventInfo_t *info, uint8_t *data, uint32_t len);	//添加进入头文件，方便其他.c调用，以免出现警告
/**@} */
